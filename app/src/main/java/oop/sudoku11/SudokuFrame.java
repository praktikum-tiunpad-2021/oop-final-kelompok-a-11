...
public class SudokuFrame extends JFrame {
    ...
    public SudokuFrame() {
        ...
        /*
         * need to include this when solving algorithm is improved JMenuItem
         * sixteenBySizteenGame = new JMenuItem("16 By 16 Game");
         * sixteenBySizteenGame.addActionListener(new
         * NewGameListener(SudokuPuzzleType.SIXTEENBYSIXTEEN,16));
         */
