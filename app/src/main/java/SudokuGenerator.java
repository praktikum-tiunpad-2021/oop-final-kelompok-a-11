...
public class SudokuGenerator {
    ...
    SudokuPuzzle key = new SudokuPuzzle();

    public SudokuPuzzle generateRandomSudoku(String difficulty) {
        ...
        int numberOfValuesToKeep = 0;

        if (difficulty == "easy") {
            numberOfValuesToKeep = 36;
        } else if (difficulty == "medium") {
            numberOfValuesToKeep = 18;
        } else if (difficulty == "hard") {
            numberOfValuesToKeep = 9;
        }
    ...
    /**
     * Solves the sudoku puzzle Pre-cond: r = 0,c = 0 Post-cond: solved puzzle
     * 
     * @param r: the current row
     * @param c: the current column
     * @return valid move or not or done Responses: Erroneous data
     */
